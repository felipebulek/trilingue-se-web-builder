        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <div className="relative">
              <div className="w-full h-80 rounded-lg bg-trilingue-blue/10"></div>
              <div className="absolute -bottom-6 -right-6 w-64 h-64 rounded-lg border-4 border-trilingue-orange"></div>
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="bg-white rounded-lg shadow-lg p-6 max-w-sm">
                  <h3 className="text-xl font-semibold text-trilingue-blue mb-2">Professora Ana Bulek</h3>
                  ...
                  <div className="flex space-x-2">
                    <div className="h-2 w-2 rounded-full bg-trilingue-blue"></div>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-2xl font-semibold text-trilingue-blue mb-3">Metodologia Personalizada</h3>
            ...
            <div>
              <h3 className="text-2xl font-semibold text-trilingue-blue mb-3">Flexibilidade Total</h3>
              <p className="text-gray-700">
            ...
            <Button className="bg-trilingue-blue hover:bg-trilingue-lightblue text-white mt-4">
